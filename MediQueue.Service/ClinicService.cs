...
public class ClinicService : IClinicService
{
    ...
    public async Task<ClinicProfileDto?> GetClinicByUserIdAsync(int userId)
    {
  ...
  return MapToClinicProfileDto(clinic);
    ...
    public async Task<ClinicProfileDto> CreateClinicProfileAsync(int userId, CreateClinicProfileDto dto)
    {
        // Check if clinic already exists for this user
        if (await _unitOfWork.Clinics.ClinicExistsForUserAsync(userId))
